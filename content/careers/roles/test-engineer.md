---
title: "Test Engineer – Web & AI Applications"
...
- 3+ years of professional experience in QA Engineering, Test Automation, SDET, Software Engineering, or a closely related role.
- Strong experience testing production web applications.
- Hands-on experience with at least one browser automation framework such as Playwright, Cypress, Selenium, or WebdriverIO.
- Experience writing automated UI, integration, regression, and end-to-end tests.
- Working knowledge of JavaScript/TypeScript, Python, Java, or another programming language used for test automation.
- Strong understanding of selectors, DOM behavior, browser events, asynchronous operations, and network requests.
- Understanding of test isolation, fixtures, mocking, test data management, and reproducibility.
- Experience diagnosing flaky or nondeterministic tests.
- Familiarity with API testing using tools or libraries such as Postman, REST Assured, pytest, Supertest, or similar.
- Familiarity with Git and modern software development workflows.
- Strong debugging and analytical problem-solving skills.
- Excellent attention to detail and ability to communicate technical findings clearly.

## AI-Assisted Engineering

AI is becoming an important part of modern software development and testing. We are particularly interested in candidates who know how to use AI effectively while maintaining strong engineering judgment.
...
Our application process is designed to evaluate both your testing experience and your ability to communicate technical decisions.

The process may include:

1. Resume or professional profile review
2. Initial screening
3. AI-assisted technical interview
4. Practical testing or technical evaluation
5. Final team conversation

During the interview, be prepared to discuss real testing projects, automation frameworks you have used, difficult bugs you have diagnosed, flaky tests you have fixed, and how you use AI tools in your engineering workflow.
